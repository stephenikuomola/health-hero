...
class AppComponent {
    ...
    #handleValidationAndCalculation() {
        ...
        if (this.#metricRadio.checked) {
            ...
            if (!isFinite(kg) || !isFinite(cm) || kg < MIN_KG || kg > MAX_KG || cm > MAX_CM || cm < MIN_CM) {
        ...
        if (this.#imperialRadio.checked) {
            ...
            if (!isFinite(st) || !isFinite(lbs) || !isFinite(ft) || !isFinite(inches) || ft < MIN_FEET || ft > MAX_FEET || inches < MIN_INCHES || inches > MAX_INCHES || st < MIN_STONE || st > MAX_STONE || lbs < MIN_POUNDS || lbs > MAX_POUNDS) {
    ...
    #showErrorMessage(value, input, identifier) {
        ...
        } else if (value < MIN_KG && identifier == "kilogram" || value < MIN_CM && identifier == "centimeter" || value < MIN_FEET && identifier == "feet" || value < MIN_INCHES && identifier == "inches" || value < MIN_STONE && identifier == "stone" || value < MIN_POUNDS && identifier == "pounds") {
            this.#errorMessage(input, "Number is too Small");
            this.#resetDisplayResult();
        } else if (value > MAX_KG && identifier == "kilogram" || value > MAX_CM && identifier == "centimeter" || value > MAX_FEET && identifier == "feet" || value > MAX_INCHES && identifier == "inches" || value > MAX_STONE && identifier == "stone" || value > MAX_POUNDS && identifier == "pounds") {
