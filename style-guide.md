...
--gradient: linear-gradient(
  90deg hsl(227, 92%, 59%) 0% hsl(227, 100%, 67%) 100%
);
```
...
--fs-2: clamp(1rem, calc(0.97rem + 0.22vw), 1.17rem);
...
--fs-6: clamp(3.16rem, calc(3.06rem + 0.7vw), 3.68rem);
```
...
--space-6: clamp(1.5rem, calc(1.45rem + 0.33vw), 1.75rem);
--space-7: clamp(2.25rem, calc(2.18rem + 0.5vw), 2.63rem);
--space-8: clamp(3rem, calc(2.9rem + 0.66vw), 3.5rem);
--space-9: clamp(4.5rem, calc(4.36rem + 0.99vw), 5.25rem);
--space-9: clamp(6rem, calc(5.81rem + 1.32vw), 7rem);
--space-1-2: clamp(0.19rem, calc(0.14rem + 0.33vw), 0.44rem);
--space-2-3: clamp(0.38rem, calc(0.32rem + 0.41vw), 0.69rem);
--space-3-4: clamp(0.56rem, calc(0.5rem + 0.41vw), 0.88rem);
--space-4-5: clamp(0.75rem, calc(0.64rem + 0.74vw), 1.31rem);
--space-5-6: clamp(1.13rem, calc(1.01rem + 0.83vw), 1.75rem);
--space-6-7: clamp(1.5rem, calc(1.29rem + 1.49vw), 2.63rem);
--space-7-8: clamp(2.25rem, calc(2.01rem + 1.65vw), 3.5rem);
--space-8-9: clamp(3rem, calc(2.57rem + 2.98vw), 5.25rem);
--space-9-10: clamp(4.5rem, calc(4.02rem + 3.31vw), 7rem);
--space-4-6: clamp(0.75rem, calc(0.56rem + 1.32vw), 1.75rem);
--space-6-8: clamp(1.5rem, calc(1.12rem + 2.64vw), 3.5rem);
